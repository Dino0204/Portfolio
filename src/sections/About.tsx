      ...
      >
        ...
        <div className="mb-16 space-y-4 max-w-2xl">
          ...
          <p className="text-[16px] font-normal leading-[1.6] text-muted">
            ...
            전체를 고민하는 개발자를 지향합니다. 디자인은 공식적인 협업 경험이
            없지만, 개인적인 관심으로 다양한 레퍼런스를 참고하고 AI를 활용해
            직접 만들어보며 감각을 키우고 있습니다. 이 포트폴리오 사이트도 그
            과정의 일부입니다. 학생이라 경험은 아직 부족하지만, 이 과정
            하나하나가 언젠가 온전히 제 손으로 만드는 서비스를 위한 초석이 될
            거라 믿습니다.
          </p>
        </div>
